...
<body>
	...
	<div class="tabla">
		<form action="pelea" method="post" enctype="multipart/form-data">
						...
						<td><div class="form-group">
								<select class="form-control" id="id1" name="id1" required>
									...
									<c:forEach items="${hero }" var="hero1">
										<option>${hero1.nombre }</option>
									</c:forEach>
								</select>
							</div></td>
						<td>
							<button type="submit" class="btn btn-danger">VS</button>
						</td>
						<td><div class="form-group">
								<select class="form-control" id="id2" name="id2" required>
									<option selected></option>
									<c:forEach items="${mon }" var="mon1">
										<option>${mon1.nombre }</option>
									</c:forEach>
								</select>
							</div></td>
					</tr>
